 ...
 * @author jonathan
 */
public class Sumar extends Expresion implements Funcion {

    Expresion id;
    Expresion clave;

    public Sumar(Expresion id, int linea, int columna, Expresion clave) {
    ...
    public Expresion obtenerValor(Entorno ent) {
        ...
        if (VerfificaParametro(parametro1, parametro2)) {
            ...
            Simbolo sim = arch.Sumar(new Literal(TipoDato.cadena, cl, linea, columna));
    ...
    public Boolean VerfificaParametro(Expresion parametro1, Expresion parametro2) {
        ...
        if ((parametro1.tipo.compareTo(TipoDato.archivo) == 0)
            ...
            descripcion = "Se nececsita una cadena como segundo parametro de la funcion sumar";
            System.out.println(descripcion);
            er.setError("", linea, columna, "Reporte: Semantico", descripcion);
