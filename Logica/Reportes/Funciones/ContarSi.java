 ...
 * @author jonathan
 */
public class ContarSi extends Expresion implements Funcion {
    ...
    public ContarSi(Expresion id, Expresion clave1, Expresion clave2, OpRel rel, int linea, int columna) {
        this.id = id;
        this.clave1 = clave1;
        this.clave2 = clave2;
        this.rel = rel;
    ...
    public Expresion obtenerValor(Entorno ent) {
        ...
        if (VerfificaParametro(parametro1, parametro2, parametro3)) {
            ...
            Simbolo sim = arch.ContarSi(clave1, clave2, rel);
    ...
    public Boolean VerfificaParametro(Expresion parametro1, Expresion parametro2, Expresion parametro3) {
        ...
        if ((p1isArchivo && p2isCadena) && (p3isCadena || p3isNum)) {
            ...
            String descripcion = "ALguno des los parametros de la Funcion Contar si es incorrecto Revisar los parametros ingresados ";
